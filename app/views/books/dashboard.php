...
<body class="flex justify-center items-center mt-5 bg-gray-200">
    ...
    <!-- Col 2 -->
        <div class="w-72 h-96 bg-gray-300 rounded-md p-3 shadow-md shadow-md hover:shadow-lg hover:scale-105 transition duration-300">
            ...
            <button class="w-24 h-8 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 mt-12"><a href="/books/index" class="text-white">See Details</a></button>
        </div>
    ...
    <!-- Col 3 -->
        <div class="w-72 h-96 bg-gray-300 rounded-md p-3 shadow-md shadow-md hover:shadow-lg hover:scale-105 transition duration-300">
            ...
            <button class="w-24 h-8 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 mt-12"><a href="/publishers/index" class="text-white">See Details</button>
        </div>
        ...
        <div class="w-72 h-96 bg-gray-300 rounded-md p-3 shadow-md shadow-md hover:shadow-lg hover:scale-105 transition duration-300">
            ...
            <button class="w-24 h-8 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 mt-12">
            <a href="/loans/index" class="text-white">See Details</a></button>
        </div>
