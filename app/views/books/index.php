...
<body class="min-h-screen bg-gray-400">
    ...
    <div class="container mx-auto px-4 flex flex-col min-h-screen">
        <div class="flex-1 flex flex-col items-center">
            ...
            <table id="books" class="mt-2 table-auto w-3/4 rounded-lg shadow-lg overflow-hidden text-sm text-left">
                ...
                <tbody>
                    <!-- Memulai iterasi untuk setiap elemen dalam array $books -->
                    <!-- Variabel $book akan merepresentasikan setiap data buku secara individual -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() { // Mengambil elemen tabel dan bagian-bagian yang diperlukan untuk pengolahan data
