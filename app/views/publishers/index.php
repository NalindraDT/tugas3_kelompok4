...
<div class="container mx-auto px-4 flex flex-col min-h-screen">
    ...
    <div class="mt-2 flex justify-between w-3/4">
            <a href="../publishers/dashboard" class="w-20 h-9 bg-gray-500 text-white text-sm font-medium rounded-md hover:bg-gray-600 transition duration-300 text-center flex items-center justify-center"><i class="fa fa-arrow-left mr-2"></i>Back</a>
